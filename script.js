...
// const headingTag = document.querySelector("h1"); //select by tag name (in this case returns the first Element within the document that matches the specified selector)
...
// console.log(headingEl.textContent); //getter
...
// console.log(headingEl.innerHTML); //getter
// headingEl.innerHTML = "Hello <span class='heading--big'>everyone</span>!"; //setter
...
// CLOSURE ARE FUNCTION THAT ACCESS VALUES OUTSIDE THEIR CURLY BRACES
//THIS IS A CLOSURE:
//the function accesses the a variable wich is defined outside the scope of the function (in the global environment)
// var b = 1;
// function impureFun(a) {
//   return a + b;
// }
// console.log(impureFun(2)); //returns 3

//THIS IS A CLOSURE:
// the state constant is accessed inside the function, thus it is a closure
// const state = "NY";
// function callMe() {
...
//THIS IS A PURE FUNCTION (NOT A CLOSURE!!!):
//it depends ONLY on its own arguments:
// function pureFunction(a, b) {
//   return a + b;
// }
// console.log(pureFunction(2, 3));
//when the pure function is called it is pushed in the CALL STACK!!! The call stack is SHORT LIVED, deleted by memory after the function is invoked
//the variables of the arguments will be send in the stack: 2, 3, the function in the call stack, sent in memory and then popped off the call stack after being called

//THIS IS A CLOSURE:
//NOTE: a closure requires more memory and computation power than a pure function
// let b = 3; //free variable
// function impureFunction(a) {
//   //returns function scope plus outer scope
//   return a + b; //captures b
// }
// console.log(impureFunction(2));
//when the impure function is called (CLOSURE) it is pushed in the HEAP. Unlike the call stack it is LONG LIVED and deleted after by the garbage collector

//PRACTICAL USE:DATA INCAPSULATION
// function outer() {
//   let state = "🐇";
//   function inner() {
//     return `Hello ${state}`;
...
//   return inner;
// }
//OTHER PRACTICAL USE: function factories, ex:
...
// a closure is a  combination of a function and it's lexical environment
// context when a function is defined
// the variable is allocated in the heap
// heap -> closure
// stack -> no closure

//CLOSURE
//var keyword: var hosted to global scope
// for (var i = 0; i < 3; i++) { //returns 3 3 3
// const log = () => {
//   // debugger; //to ckeck the result of the variable
//   console.log(i);
// };
// setTimeout(log, 100);
// }
// the setTimeout function is completed after 100ms when the cycle is completed, thus returning 3 3 3

//NOT A CLOSURE
//let keyword: let NOT hosted to global scope, it's BLOCK SCOPED
//returns 0 1 2 referencing to the variable i defined inside the block of the for loop
// for (let i = 0; i < 3; i++) {
//   const log = () => {
//     // debugger; //to ckeck the result of the variable
//     console.log(i);
